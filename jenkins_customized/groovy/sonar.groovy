...
// Variables
def sonar_server_url = env['http://34.73.25.68:9000']
def sonar_auth_token = env['']
def sonar_plugin_version = env['']
def sonar_additional_props = env['']

def sonar_runner_version = env['']
